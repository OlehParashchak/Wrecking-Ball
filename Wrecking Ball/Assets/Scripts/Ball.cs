...
public class Ball : MonoBehaviour
{
    ...
    private int currentBrokernStacks, totalStacks;
    ...
    void OnCollisionEnter(Collision target)
    {
        ...
        FindObjectOfType<GameUI>().LevelSliderFill(currentBrokernStacks / (float)totalStacks);
